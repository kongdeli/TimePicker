...
//            if (mPickerOptions.minuteInterval == 5) {
//                int currentMinute = calendar.get(Calendar.MINUTE);
//                if (currentMinute >= 55) {
//                    //分钟数到达55，直接减去分钟数，再加1小时。
//                    currentTimeMillis = currentTimeMillis - ((long) currentMinute * 60 * 1000) + 60 * 60 * 1000;
//                    calendar.setTimeInMillis(currentTimeMillis);
//                }
//            }
            ...
            Calendar calendar1 = mPickerOptions.date;
            int settedMinute = calendar1.get(Calendar.MINUTE);
            long needAddedTime;
            if (mPickerOptions.minuteInterval == 5) {
                if (settedMinute % 10 <5) {
                    needAddedTime = (5 - settedMinute % 10) * 60 * 1000;
                } else {
                    needAddedTime = (10 - settedMinute % 10) * 60 * 1000;
                }
                long correctedTimeInMillis = calendar1.getTimeInMillis() + needAddedTime;
                calendar1.setTimeInMillis(correctedTimeInMillis);
            }
